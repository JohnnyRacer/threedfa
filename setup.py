...
setup(
  ...
  #  author_email="testrr@13.com",
    ...
    python_requires=">=3.6",
    install_requires = ['python-dotenv>=0.20.0' ,'uvicorn>=0.17.6','starlette>=0.17.1' ,'torch>=1.11.0', 'torchvision>=0.12.0', 'matplotlib==3.5.1', 'numpy>=1.19.5', 'opencv-python', 'pyyaml>=6.0','scikit-image>=0.19.2', 'scipy>=1.7.2','cython>=0.29.28' ,'onnxruntime==1.8.0']
)
