...
setup(
  ...
  #  author_email="testrr@13.com",
    ...
    python_requires=">=3.6",
     install_requires = ['pillow>=9.0.1' ,'torch>=1.11.0', 'torchvision>=0.12.0', 'matplotlib==3.5.1', 'numpy>=1.19.5', 'opencv-python==4.5.5.64', 'pyyaml>=6.0','scikit-image>=0.19.2', 'scipy>=1.8.0','cython>=0.29.28' ,'onnxruntime==1.8.0']
)
