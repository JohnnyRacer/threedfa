...
setup(
  ...
  #  author_email="testrr@13.com",
    ...
    python_requires=">=3.6",
     install_requires = ['torch>=1.11.0', 'torchvision>=0.12.0', 'matplotlib==3.5.1', 'numpy>=1.19.5', 'opencv-python>=4.5.5.64', 'pyyaml>=3.11','scikit-image>=0.19.2', 'scipy>=1.8.0', 'onnxruntime==1.8.0']
)
