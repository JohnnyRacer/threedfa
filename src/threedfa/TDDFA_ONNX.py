...
class TDDFA_ONNX(object):
    ...
    def __init__(self, **kvs):
        ...
        bfm_fp = kvs.get('bfm_fp', make_abs_path(f'{abs_cfg_path}/bfm_noneck_v3.pkl'))
        ...
        param_mean_std_fp = kvs.get(
            'param_mean_std_fp', make_abs_path(f'{abs_cfg_path}/param_mean_std_62d_{self.size}x{self.size}.pkl')
        )
